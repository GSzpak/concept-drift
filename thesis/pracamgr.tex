...
Kwantylem rzêdu $p$ $q_p(T_n)$ nazwiemy taki element $x_k$, ¿e dok³adnie $p$ elementów szeregu jest od niego mniejszych. W procesie ekstrakcji cech u¿yto siedmiu kwantyli, rzêdów kolejno: 0.125, 0.25, 0.375, 0.5, 0.625, 0.75, 0.875. 
...
\captionsetup{justification=centering}
\captionsetup{width=0.8\textwidth}
\includegraphics[scale=0.8]{skewness.png}
