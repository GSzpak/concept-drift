...
Je¶li przewidywana zmienna $C$ jest zmienn± dyskretn± przyjmuj±c± $m$ warto¶ci $c_1, c_2, \dots, c_m$, \emph{entropia} - inaczej mówi±c, pocz±tkowa niepewno¶æ - definiowana jest jako
...
Znajduje to swoje odwzierciedlenie w otrzymanych rezultatach. Najwiêkszy zysk wydajno¶ci zaobserwowano dla klasyfikatorów liniowych. Wynik na zbiorze testowym dla regresji logistycznej i SVM dla odpowiednich warto¶ci progów poprawi³ siê nawet o $0.15$ , przy jednoczesnym niewielkim spadku $BAC$ na zbiorze treningowym.
...
\hline
$threshold_{class}$ & $threshold_{drift}$ & Liczba cech   & $X_{train}$ $BAC$ & $X_{test}$ $BAC$ \\ \hline
0.0                 & 8000                & 5355          & 0.9948            & 0.7222           \\ \hline
...
\textbf{250}        & \textbf{250}        & \textbf{1890} & \textbf{0.9919}   & \textbf{0.7459}  \\ \hline
