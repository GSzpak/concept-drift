...
Istotnym wk³adem niniejszej pracy jest tak¿e zaproponowanie usprawnienia powy¿szego podej¶cia, które to usprawnienie polega na wykrywaniu ¼ród³a danych bezpo¶rednio ze zbioru treningowego. W tym celu zastosowano analizê skupieñ, a konkretnie algorytm k-centroidów. Takie spojrzenie niesie ze sob± wiele zalet. Przede wszystkim czyni opisywan± metodê u¿yteczn± w przypadku uczenia indukcyjnego (czyli w przypadku, gdy zbiór testowy jest niedostêpny). Pozwala te¿ na lepsze okre¶lenie jako¶ci cech dla problemu detekcji \textit{concept drift} - ranga atrybutów jest mierzona wzglêdem identyfikatorów ¼róde³. Z wymienionych powodów autor wierzy, ¿e to podej¶cie bêdzie dalej rozwijane i analizowane - przyk³adowo przez wykorzystanie innych algorytmów klasteryzacji. \\
Warte zastanowienia jest równie¿ pytanie, jak zachowa³aby siê metoda opisywana w rozdziale \ref{r:drift_reduction}., gdyby badany zbiór danych zawiera³ identyfikatory ¼róde³ danych (w tym przypadku - identyfikatory stra¿aków). Autor liczy na to, ¿e posiadanie informacji o pochodzeniu danej instancji mog³oby wyra¼nie poprawiæ uzyskane rezultaty. Jest to o tyle istotne, ¿e w codziennym ¿yciu dodanie takiej informacji do zbioru danych jest zwykle niek³opotliwe. \\
