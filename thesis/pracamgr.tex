...
Mówi±c o problemie ewoluuj±cych pojêæ, nale¿y wspomnieæ o zagadnieniu przeuczenia (ang. \textit{overfitting}). Polega on na zbudowaniu modelu nadmiernie dopasowanego do danych treningowych, co skutkuje s³ab± jego jako¶ci±. \\
