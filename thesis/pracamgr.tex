...
\captionsetup{justification=centering}
\captionsetup{width=0.8\textwidth}
\caption{Jako¶æ klasyfikacji dla ró¿nych warto¶ci progowych przy u¿yciu regresji logistycznej}
...
\captionsetup{justification=centering}
\captionsetup{width=0.8\textwidth}
\caption{Jako¶æ klasyfikacji dla ró¿nych warto¶ci progowych przy u¿yciu SVM}
...
\captionsetup{justification=centering}
\captionsetup{width=0.8\textwidth}
\caption{Jako¶æ klasyfikacji dla ró¿nych warto¶ci progowych przy u¿yciu lasów losowych}
