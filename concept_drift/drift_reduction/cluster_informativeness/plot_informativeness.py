...
from concept_drift.drift_reduction.cluster_informativeness.cluster_informativeness import \
    get_cluster_drift_informativeness
...
def main(training_data_path, training_labels_path, data_for_clustering_path, info_measure_name):
    ...
    y = get_cluster_drift_informativeness(
        training_data,
